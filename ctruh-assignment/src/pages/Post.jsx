...
const Post = () => {
    ...
    color:"white" // Add cursor style for click indication
           ...
           <CreatePost posts={posts} setPosts={setPosts} modalOpen={modalOpen} setModalOpen={setModalOpen} />
                ...
                {posts.map(post => (
                    ...
                    <Link to={`/post/${post.id}`} className={styles.linkClass}>
                        ...
                        <button onClick={() => handleLike(post.id)}
                            style={{
                                background: "teal", borderStyle: "none", padding: "10px", borderRadius: "5px",
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: "teal", padding: "10px", borderRadius: "5px"
                                , fontWeight: "600"
                            }}>🗑️</button>
                    </div>
